...
module.exports = (app) => {
    ...
    // Обработчики маршрутов. Первый параметр сам роут, второй метод который по нему вызывается
    ...
    // module.exports, чтобы затем вызвать этот файл в app.js и использовав его через app.use(/путь, этот файл).
    // См. ProductApp
    // Сопоставление главной точки с обработчиком
